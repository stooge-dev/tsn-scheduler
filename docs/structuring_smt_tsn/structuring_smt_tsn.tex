...
\author{\IEEEauthorblockN{1\textsuperscript{st} Till Sahm}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{name of organization (of Aff.)}\\
City, Country \\
email address or ORCID}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Prof. Dr. Dieter Hutter}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{name of organization (of Aff.)}\\
City, Country \\
email address or ORCID}}
...
We want to experiment if we can train a ML model for selecting the best subset of streams to be scheduled. Can we use ML on different parameters for scheduling? Can we schedule via ML or can we guide the SMT solver with ML?
